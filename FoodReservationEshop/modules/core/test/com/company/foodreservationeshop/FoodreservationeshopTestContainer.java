package com.company.foodreservationeshop;
...
public class FoodreservationeshopTestContainer extends TestContainer {

    public FoodreservationeshopTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/foodreservationeshop/app.properties",
    ...
    public static class Common extends FoodreservationeshopTestContainer {

        public static final FoodreservationeshopTestContainer.Common INSTANCE = new FoodreservationeshopTestContainer.Common();
